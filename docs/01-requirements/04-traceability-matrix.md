...
| FR-7.1–7.17 memory/canon/knowledge | `04-memory-canon/01`–`03` | `fact`, `event`, `knowledge-state`, `relationship-state`, `canon-delta`, `canon-commit`, `evidence-span`, `story-clock` | 0006, 0007, 0008, 0009, 0022, 0023 | B-0-5, B-1-6…1-11, 1-15, B-2-8 | §3 integration; §7 long-form |
...
| NFR-F integrity | `06-system/02` §12 | `evidence-span`, `story-clock` | 0022, 0024 | B-0-3, B-0-5 | §2, §3 |
